...
class PySwitchTopo(Topo):
    ...
    def __init__(self, args):
        ...
        self.addHost('client3', **nodeconfig)


        
        for node in ['server1','server2','server3','client1','client2','client3']:
...
def setup_addressing(net):
    ...
    reset_macs(net, 'client1', '50:00:00:00:00:{:02x}')
    reset_macs(net, 'client2', '60:00:00:00:00:{:02x}')
    reset_macs(net, 'client3', '70:00:00:00:00:{:02x}')
    ...
    set_ip(net, 'client1','switch','192.168.100.4/24')
    set_ip(net, 'client2','switch','192.168.100.5/24')
    set_ip(net, 'client3','switch','192.168.100.6/24')
